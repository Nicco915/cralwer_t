...
function buildServiceConfig(config) {
  return {
    ...
    proxyAssignmentsFile: config.proxyAssignmentsFile || path.resolve('./output', 'proxy-assignments.json'),
    ...
    cliproxyAssignmentsFile: config.cliproxyAssignmentsFile || path.resolve('./output', 'cliproxy-assignments.json'),
    ...
    adaptiveDataLayerThreshold: config.adaptiveDataLayerThreshold !== undefined ? Number(config.adaptiveDataLayerThreshold) : 2,
    dataLayerProxyRotationThreshold: config.dataLayerProxyRotationThreshold !== undefined ? Number(config.dataLayerProxyRotationThreshold) : 2,
